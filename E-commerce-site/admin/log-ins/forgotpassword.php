...
require_once '../../includes/config.php';
 if (isset($_POST['submit'])){
  ...
  if($_POST['password']==$_POST['repeatpassword']){
    ...
    try {
        //code...
        $sql = "UPDATE admin SET password='$newpasswordhash',repeatpassword='$repeatpasswordhash'  where email='" . $_POST["email"] . "' ";
        $sth = $DBH->prepare($sql);
        $sth->execute(array());
...
<div class="container-fluid p-0">
  ...
  <style>
        ...
        <div class="picture" style="margin-top:40px;">
            <img src="../../assets/imgs/log-in.jpg" alt="" height="490px"  width="400px">
        </div>
