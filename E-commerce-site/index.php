...
<body>
  ...
  <div class="bg-light">
    ...
    <p >
      <marquee> 
        For Complain Complement Enquiry Contact us Via <i class="fa fa-phone" style="font-size:24px">+254100186941</i> or <i class="fa fa-envelope" style="font-size:24px color:blue;"> info@smoby.com</i>
          </marquee>
      </p>
  </div>
