...
<div class="container-fluid p-0">
  ...
  <style>
        ...
        <div class="picture" style="margin-top:40px;">
            <img src="../assets/imgs/shopping.jpg" alt="" height="570px"  width="400px">
        </div>
        <div class="form-information" style="margin-top:40px;">
        <form action="Register.php" method="POST">
        <div class="form-container">
            <div class="container">
                <h3 style="display:flex; font-weight:bold;"><img src="../assets/imgs/ad.png" alt="" width="50" style="margin-right:10px"> Join smoby grocersshop community </h3>
                <hr><br>
