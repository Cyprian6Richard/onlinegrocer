...
<head>
    ...
    <link rel="icon" href="/opt/lampp/htdocs/onlinegrocery/assets/imgs/download.png" type="image/icon type">
    <!--boostrapcsslink-->
...
<body>
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg navbar-light bg-info">
            <div class="container-fluid">
                <img src="/opt/lampp/htdocs/onlinegrocery/assets/imgs/download.png" alt="" style="width: 7%; height: 7%;">
   ...
   <div class="row">
       <div class="col-md-12 bg-secondary p-1 d-flex aling-items-center">
           <div class="p-3">
           <a href="#" >
               <img src="admin_area/img/ad.png" alt="admin profile" style="height: 90px;width: 90px;">
           </a>
